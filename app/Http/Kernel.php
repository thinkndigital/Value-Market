...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\GetDefaultData::class,
            \App\Http\Middleware\SetDefaultStore::class,
    ...
    protected $middlewareAliases = [
        ...
        'CheckStoreNotEmpty' => \App\Http\Middleware\CheckStoreNotEmpty::class,
        'CheckDefaultStore' => \App\Http\Middleware\CheckDefaultStore::class,
    ];
