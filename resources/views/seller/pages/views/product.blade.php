...
@section('content')
    ...
    <div class="container-fluid mt-5 mb-5 px-6">
        <x-seller.breadcrumb :title="labels('admin_labels.view_product', 'View Product')" :subtitle="labels('admin_labels.view_product_details_and_analytics', 'View Product Details & Analytics')" :breadcrumbs="[
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <h3 class="mb-3">
                                    {{ app(TranslationService::class)->getDynamicTranslation(Product::class, 'name', $data->id, $language_code) }}
                                </h3>
                                ...
                                <div class="d-flex justify-content-between ">
                                    @if ($data->type == 'simple_product')
                                        <div class="d-flex mt-4">
                                            <p class="special_price mx-2">
                                                {{ $product_variants[0]['special_price'] }}
                                            </p>
                                            <p class="main_price">
                                    ...
                                    <div class="d-flex mb-3">
                                        @if ($data->rating > 0)
                                            <div id="" data-rating="{{ $data->rating }}"
                                ...
                                <p> {{ app(TranslationService::class)->getDynamicTranslation(Product::class, 'short_description', $data->id, $language_code) }}
                                </p>
                                ...
                                <div class="d-flex">
                                    <p class="me-3 mb-1 product_information_label">
                                        {{ labels('admin_labels.cancelable', 'Cancelable') }} :
                                    </p>
                                    <p class="order_page_title mb-0">
                                ...
                                <div class="d-flex">
                                    <p class="me-3 mb-1 product_information_label">
                                        {{ labels('admin_labels.returnable', 'Returnable') }} :
                                    </p>
                                    <p class="order_page_title mb-0">
                                ...
                                <div class="d-flex">
                                    <p class="me-3 mb-1 product_information_label">
                                        {{ labels('admin_labels.warrenty_period', 'Warranty Period') }} :
                                    </p>
                                    <p class="order_page_title mb-0">
                                            ...
                                            @foreach ($attribute_values as $attribute_data)
                                                @foreach ($attribute_data['attribute_values'] as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>{{ $value . ' | ' . $attribute_values[0]['attribute_name'] }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endforeach
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link tab_link" id="product-faqs-tab" data-bs-toggle="tab"
                                data-bs-target="#product-faqs" type="button" role="tab"
