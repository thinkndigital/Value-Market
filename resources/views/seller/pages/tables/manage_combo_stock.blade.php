...
@section('content')
    <section class="main-content">
        <div class="row">
            <x-seller.breadcrumb :title="labels('admin_labels.stock_manage', 'Combo Stock Manage')" :subtitle="labels('admin_labels.know_your_stock_grow_your_business', 'Know your stock, grow your business')" :breadcrumbs="[
                ['label' => labels('admin_labels.manage', 'Manage')],
                ['label' => labels('admin_labels.stock_manage', 'Combo Stock Manage')],
            ]" />
                        ...
                        <div class="col-md-12">
                            <div class="pt-0">
                                <div class="table-responsive">
                                    <table id='seller_combo_product_stock_table' data-toggle="table"
