...
@section('title')
    {{ labels('admin_labels.combo_product_deliverability', 'Combo Product Deliverability') }}
@endsection
@section('content')
    <section class="main-content">
        <div class="row">
            <x-seller.breadcrumb :title="labels('admin_labels.combo_product_deliverability', 'Combo Product Deliverability')" :subtitle="labels(
                'admin_labels.manage_which_zones_your_combo_products_deliver_to',
                'Manage Which Zones Your Combo Products Deliver To',
            )" :breadcrumbs="[['label' => labels('admin_labels.combo_product_deliverability', 'Combo Product Deliverability')]]" />
                ...
                <div class="card content-area p-4 ">
                    <div class="row align-items-center d-flex heading mb-5">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4>{{ labels('admin_labels.combo_product_deliverability', 'Combo Product Deliverability') }}
                                    </h4>
                                </div>
                                <div class="col-md-6 d-flex justify-content-end">
                                    <button type="button"
                                        class="btn btn-dark me-2 bulk_update_combo_deliverability_data"
                                        data-table-id="seller_combo_deliverability_table">{{ labels('admin_labels.update_deliverability', 'Update Deliverability') }}</button>
                                    ...
                                    <a class="btn me-2" id="tableRefresh"
                                        data-table="seller_combo_deliverability_table"><i
