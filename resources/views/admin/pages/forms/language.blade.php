                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group mt-2">
                                <a href="{{ route('admin.download-language-labels') }}"
                        ...
                        <div class="col-md-3">
                            <div class="form-group mt-2">
                                <a href="{{ route('admin.download-language-sample-file') }}"
                                    class="btn btn-primary btn-sm instructions_files">
                        ...
                        @php
                            $language_file = base_path("resources/lang/{$language_code}/admin_labels.php");
                        @endphp

                        @if (file_exists($language_file))
                            <div class="col-md-5">
                                <div class="form-group mt-2">
                                    <a href="{{ route('download.language.file', ['language_code' => $language_code]) }}"
                                        class="btn btn-primary btn-sm instructions_files">
