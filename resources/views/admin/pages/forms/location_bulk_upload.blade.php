...
@section('content')
    ...
    )" :breadcrumbs="[['label' => labels('admin_labels.bulk_upload', 'Bulk Upload')]]" />
        ...
        <div class="col-md-12 col-lg-6 mt-md-2 mt-lg-0">
            <div class="bulk_upload_instruction_card">
                <ul>
                    ...
                    <li>Choose the matching Location Type (Zipcode, City or Zone) before uploading</li>
                    <li>For adding bulk locations, the file should be in .csv format</li>
