        ...
        <div class="col-md-12 col-lg-6 mt-md-2 mt-lg-0">
            <div class="bulk_upload_instruction_card">
                <ul>
                    ...
                    <li>The Name column must be a JSON object with at least an "en" key, e.g.
                        <code>{"en":"Fruits"}</code></li>
                    <li>You can copy the image path from the media section</li>
                    <li>When setting a parent category, the Store ID must match the parent category's own store</li>
