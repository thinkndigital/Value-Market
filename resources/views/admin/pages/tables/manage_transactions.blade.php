...
@section('title')
    {{ labels('admin_labels.manage_transactions', 'Manage Transactions') }}
@endsection
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.manage_transactions', 'Manage Transactions')" :subtitle="labels(
        ...
        ['label' => labels('admin_labels.manage_transactions', 'Manage Transactions')],
    ]" />

    <input type="hidden" id="transaction_user_id" value="{{ $user_id ?? '' }}">
        ...
        <div class="card content-area p-4 ">
            <div class="row align-items-center d-flex heading mb-5">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            <h4>{{ labels('admin_labels.manage_transactions', 'Manage Transactions') }}
                            </h4>
                        </div>
                        <div class="col-md-6 d-flex justify-content-end ">
                            <div class="input-group me-2 search-input-grp ">
                                <span class="search-icon"><i class='bx bx-search-alt'></i></span>
                                <input type="text" data-table="admin_transactions_table"
                                    class="form-control searchInput" placeholder="Search...">
                                <span class="input-group-text">{{ labels('admin_labels.search', 'Search') }}</span>
                            </div>
                            <a class="btn me-2" id="tableRefresh" data-table="admin_transactions_table"><i
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_transactions_table','csv')">CSV</button></li>
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_transactions_table','json')">JSON</button></li>
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_transactions_table','sql')">SQL</button></li>
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_transactions_table','excel')">Excel</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="pt-0">
                        <div class="table-responsive">
                            <table class='table' id="admin_transactions_table" data-toggle="table"
