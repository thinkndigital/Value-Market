                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <h1 class="font-weight-bolder">
                                {{ labels('admin_labels.reset_password', 'Reset Password') }}
                            </h1>
                            <div>

                                <p class="mb-4 order_page_title">Hey, reset your password.</p>
                            </div>
                        </div>

                        <form class="form_authentication" class="mb-3 form-submit-event"
                            ...
                            <div class="form-group">
                                <label for=""
                                    class="form-label">{{ labels('admin_labels.new_password', 'New password') }} <span
                                        class='text-asterisks text-sm'>*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text">
                                    ...
                                    <input type="password" class="form-control show_new_password" name="password"
                                        placeholder="Enter new password" />
                                    <span class="input-group-text cursor-pointer toggle_new_password"><i
                                            class="bx bx-hide"></i></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for=""
                                    class="form-label">{{ labels('admin_labels.confirm_new_password', 'Confirm new password') }}
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control show_confirm_password"
                            ...
                            <button type="submit"
                                class="btn btn-lg btn-primary login_button w-100 mt-4 mb-0">{{ labels('admin_labels.reset_password', 'Reset Password') }}</button>
