 ...
 <nav class="navbar-vertical navbar bg-white" {{ session()->get('is_rtl') == 1 ? 'dir=rtl' : '' }}>
     <div class="nav-scroller bg-white">
         @php
             ...
             // Sidebar regroup (32-phase SaaS brief): the sidebar used to be ~30 flat top-level sections.
             // Every route/label/permission check below is unchanged from before this pass - this only adds
             ...
             $group_marketing_active = Request::is('admin/offers*') || Request::is('admin/offer_sliders*') || Request::is('admin/promo_codes*') || Request::is('admin/sliders*') || Request::is('admin/feature_section*') || Request::is('admin/commission_rules*') || Request::is('admin/affiliate*') || Request::is('admin/blogs*') || Request::is('admin/manage_blogs*');
             $group_subscriptions_active = Request::is('admin/subscription_plans*');
             $group_website_active = Request::is('admin/media*') || Request::is('admin/storage_type*') || Request::is('admin/web_settings/theme*');
             $group_communication_active = Request::is('admin/tickets*') || Request::is('admin/chat*') || Request::is('admin/send_notification*') || Request::is('admin/send_seller_notification*') || Request::is('admin/seller_email_notification*') || Request::is('admin/custom_message*') || Request::is('admin/faq*');
             $group_locations_active = Request::is('admin/area*') || Request::is('admin/zones*');
             $group_languages_active = Request::is('admin/settings/language*') || Request::is('admin/settings/manage_language*') || Request::is('admin/language/bulk_translation_upload*') || Request::is('admin/web_settings/language*');
             $group_reports_active = Request::is('admin/reports*') || Request::is('admin/settings/sales_reports*');
             $group_system_active = Request::is('admin/settings') || Request::is('admin/web_settings/general_settings*') || Request::is('admin/web_settings/pwa_settings*') || Request::is('admin/web_settings/firebase*') || Request::is('admin/system_users*') || Request::is('admin/manage_system_users*');
         @endphp
         ...
         <ul class="navbar-nav" id="menuList">
             ...
             <li class="nav-item ms-3">
                 <a data-bs-toggle="collapse" href="#group_platform"
                     class="nav-link sidebar-group-toggle {{ $group_platform_active ? '' : 'collapsed' }} {{ $group_platform_active ? 'active' : '' }}"
                     aria-controls="group_platform" role="button" aria-expanded="false">
                     <i class='bx bx-store-alt'></i>
                     <span class="nav-link-text ms-1">{{ labels('admin_labels.group_platform', 'Platform') }}</span>
                     <i class="fas fa-angle-down"></i>
                 </a>
                 <div class="collapse {{ $group_platform_active ? 'show' : '' }}" id="group_platform">
                     <ul class="nav">
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.stores', 'Stores') }}</li>
                         <li class="nav-item ms-3">
                         ...
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.sellers', 'Sellers') }}</li>
                         <li class="nav-item ms-3">
                         ...
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.delivery_boys', 'Delivery Boys') }}</li>
                         <li class="nav-item ms-3">
             ...
             <li class="nav-item ms-3">
                 <a data-bs-toggle="collapse" href="#group_catalog"
                     ...
                     <span class="nav-link-text ms-1">{{ labels('admin_labels.group_catalog', 'Catalog') }}</span>
                     <i class="fas fa-angle-down"></i>
                 </a>
                 <div class="collapse {{ $group_catalog_active ? 'show' : '' }}" id="group_catalog">
                     <ul class="nav">
                         ...
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.brand', 'Brand') }}</li>
                         <li class="nav-item ms-3">
             ...
             {{-- ===================== ORDERS & OPERATIONS ===================== --}}
             <li class="nav-item ms-3">
                 <a data-bs-toggle="collapse" href="#group_orders"
                     class="nav-link sidebar-group-toggle {{ $group_orders_active ? '' : 'collapsed' }} {{ $group_orders_active ? 'active' : '' }}"
                     aria-controls="group_orders" role="button" aria-expanded="false">
                     <i class='bx bx-card'></i>
                     <span class="nav-link-text ms-1">{{ labels('admin_labels.group_orders', 'Orders & Operations') }}</span>
                     <i class="fas fa-angle-down"></i>
                 </a>
                 <div class="collapse {{ $group_orders_active ? 'show' : '' }}" id="group_orders">
                     <ul class="nav">
                         ...
                         @if ($user_role == 'super_admin' || $user->hasPermissionTo('view seller_wallet_transaction'))
                             <li class="nav-item ms-3">
                                 <a class="nav-link {{ Request::is('admin/sellers/seller_wallet_transaction') || Request::is('admin/sellers/seller_wallet_transaction/*') ? 'active' : '' }}"
                                     ...
                                     <span
                                         class="nav-link-text ms-1">{{ labels('admin_labels.wallet_transactions', 'Seller Wallet Transaction') }}</span>
                                 </a>
                             </li>
                         @endif
             ...
             {{-- ===================== MARKETING (Offers / Sliders / Featured / Affiliate / Blogs) ===================== --}}
             <li class="nav-item ms-3">
                 <a data-bs-toggle="collapse" href="#group_marketing"
                     ...
                     <span class="nav-link-text ms-1">{{ labels('admin_labels.group_marketing', 'Marketing') }}</span>
                     <i class="fas fa-angle-down"></i>
                 </a>
                 <div class="collapse {{ $group_marketing_active ? 'show' : '' }}" id="group_marketing">
                     <ul class="nav">
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.offers', 'Offers') }}</li>
                         <li class="nav-item ms-3">
                         ...
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.slider', 'Slider') }}</li>
                         <li class="nav-item ms-3">
                         ...
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.featured_section', 'Featured Section') }}</li>
                         <li class="nav-item ms-3">
                         ...
                         @if ($user_role == 'super_admin')
                             <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.affiliate', 'Affiliate') }}</li>
                             <li class="nav-item ms-3">
                         ...
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.blogs', 'Blogs') }}</li>
                         <li class="nav-item ms-3">
             ...
             @if ($user_role == 'super_admin')
                 <li class="nav-item ms-3">
                     <a data-bs-toggle="collapse" href="#group_subscriptions"
                         class="nav-link sidebar-group-toggle {{ $group_subscriptions_active ? '' : 'collapsed' }} {{ $group_subscriptions_active ? 'active' : '' }}"
                         aria-controls="group_subscriptions" role="button" aria-expanded="false">
                         <i class='bx bx-crown'></i>
                         <span class="nav-link-text ms-1">{{ labels('admin_labels.subscription_plans', 'Subscriptions') }}</span>
                         <i class="fas fa-angle-down"></i>
                     </a>
                     <div class="collapse {{ $group_subscriptions_active ? 'show' : '' }}" id="group_subscriptions">
                         <ul class="nav">
                             <li class="nav-item ms-3">
             ...
             {{-- ===================== THEMES & WEBSITE (Media / Theme stub) ===================== --}}
             <li class="nav-item ms-3">
                 <a data-bs-toggle="collapse" href="#group_website"
                     ...
                     <span class="nav-link-text ms-1">{{ labels('admin_labels.group_website', 'Themes & Website') }}</span>
                     <i class="fas fa-angle-down"></i>
                 </a>
                 <div class="collapse {{ $group_website_active ? 'show' : '' }}" id="group_website">
                     <ul class="nav">
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.media_manage', 'Media Manage') }}</li>
                         <li class="nav-item ms-3">
             ...
             {{-- ===================== COMMUNICATION (Support / Chat / Notifications / FAQs) ===================== --}}
             <li class="nav-item ms-3">
                 <a data-bs-toggle="collapse" href="#group_communication"
                     ...
                     <span class="nav-link-text ms-1">{{ labels('admin_labels.group_communication', 'Communication') }}</span>
                     <i class="fas fa-angle-down"></i>
                 </a>
                 <div class="collapse {{ $group_communication_active ? 'show' : '' }}" id="group_communication">
                     <ul class="nav">
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.support_tickets', 'Support Tickets') }}</li>
                         <li class="nav-item ms-3">
                         ...
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.chat_manage', 'Chat Manage') }}</li>
                         <li class="nav-item ms-3">
                         ...
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.send_notification', 'Send Notification') }}</li>
                         <li class="nav-item ms-3">
                         ...
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.custom_message', 'Custom Message') }}</li>
                         <li class="nav-item ms-3">
                         ...
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.faqs', 'FAQs') }}</li>
                         <li class="nav-item ms-3">
             ...
             <li class="nav-item ms-3">
                 <a data-bs-toggle="collapse" href="#group_locations"
                     ...
                     <i class='bx bx-map'></i>
                     <span class="nav-link-text ms-1">{{ labels('admin_labels.location_management', 'Locations') }}</span>
                     <i class="fas fa-angle-down"></i>
                 </a>
             ...
             <li class="nav-item ms-3">
                 <a data-bs-toggle="collapse" href="#group_languages"
                     ...
                     <span class="nav-link-text ms-1">{{ labels('admin_labels.language_settings', 'Languages') }}</span>
                     <i class="fas fa-angle-down"></i>
                 </a>
                     ...
                     <ul class="nav">
                         ...
                         <li class="nav-item ms-3">
                             <a class="nav-link {{ Request::is('admin/web_settings/language') || Request::is('admin/web_settings/language/*') ? 'active' : '' }}"
                                 ...
                                 <span
                                     class="nav-link-text ms-1">{{ labels('admin_labels.languages', 'Web Languages') }}</span>
                             </a>
                         </li>
                     </ul>
                 </div>
             ...
             <li class="nav-item ms-3">
                 <a data-bs-toggle="collapse" href="#group_reports"
                     ...
                     <span class="nav-link-text ms-1">{{ labels('admin_labels.reports', 'Reports') }}</span>
                     <i class="fas fa-angle-down"></i>
                 </a>
             ...
             {{-- ===================== SYSTEM (Settings / Web Settings / System Users) ===================== --}}
             <li class="nav-item ms-3">
                 <a data-bs-toggle="collapse" href="#group_system"
                     class="nav-link sidebar-group-toggle {{ $group_system_active ? '' : 'collapsed' }} {{ $group_system_active ? 'active' : '' }}"
                     aria-controls="group_system" role="button" aria-expanded="false">
                     <i class='bx bx-cog'></i>
                     <span class="nav-link-text ms-1">{{ labels('admin_labels.group_system', 'System') }}</span>
                     <i class="fas fa-angle-down"></i>
                 </a>
                 <div class="collapse {{ $group_system_active ? 'show' : '' }}" id="group_system">
                     <ul class="nav">
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.system_settings', 'System Settings') }}</li>
                         <li class="nav-item ms-3">
                         ...
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.web_settings', 'Web Settings') }}</li>
                         <li class="nav-item ms-3">
                         ...
                         <li class="sidebar-subtitle ms-3">{{ labels('admin_labels.system_users', 'System Users') }}</li>
                         <li class="nav-item ms-3">
