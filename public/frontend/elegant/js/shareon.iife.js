var Shareon = function(r) {
                        ...
                        for (let n = 0; n < p; n += 1) {
                            ...
                            if (Object.prototype.hasOwnProperty.call(o, i)) {
                                const s = {
                                    ...
                                    h = o[i](s);
                                e.tagName.toLowerCase() === "a" ? (e.setAttribute("href", h), e.setAttribute("rel", "noopener noreferrer"), e.setAttribute("target", "_blank")) : e.addEventListener("click", $(h));
                                break
                            }
                        }
                    }
    ...
    return c && c.hasAttribute("init") && l(), r.init = l, Object.defineProperty(r, Symbol.toStringTag, {
        value: "Module"
    }), r
}({});
